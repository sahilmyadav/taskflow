          ...
          <Card className="mt-6 rounded-2xl shadow-lg">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-xs">
                No password needed — we&apos;ll create a workspace for you.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={submit} className="space-y-3">
                ...
                >
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-white text-[11px] font-bold shadow">
                    G
                  </span>{' '}
                  Login with Google
                </button>
